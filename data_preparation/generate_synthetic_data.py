...
loan_durations = [np.random.randint(term-1, term+2) for term in loan_terms]  # Duration can vary within 1 week before or after the loan term
...
defaulted = [1 if duration > term + 4 or flag else 0 for duration, term, flag in zip(loan_durations, loan_terms, default_flags)]  # Considered a default if late by more than 4 weeks
